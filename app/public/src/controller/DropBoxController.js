class DropBoxController{
    ...
    connectFirebase(){
        const firebaseConfig = {
            apiKey: "AIzaSyDEezIkmWGpqa0zW3TCVzBbVH9CaDXUulo",
            authDomain: "dropbox-clone-400cc.firebaseapp.com",
            databaseURL: "https://dropbox-clone-400cc.firebaseio.com",
            projectId: "dropbox-clone-400cc",
            storageBucket: "dropbox-clone-400cc.appspot.com",
            messagingSenderId: "696951070280",
            appId: "1:696951070280:web:44861a78bc7584e0"
          };
    ...
    initEvents(){
        ...
        this.btnRenameEL.addEventListener('click', e => {
            ...
            let nome = prompt("Renomer o arquivo", file.name);
